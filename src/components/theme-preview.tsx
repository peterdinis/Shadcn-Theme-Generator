    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-zinc-50/50 dark:bg-zinc-950/30 relative">
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-primary text-primary-foreground uppercase tracking-widest">v1.2.0</span>
              <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">Design System</span>
            </div>
            <h1 className="text-4xl font-black tracking-tight mb-2">Theme Preview</h1>
            <p className="text-muted-foreground text-lg max-w-xl">
              Real-time visualization of your shadcn/ui components with premium styling and OKLCH colors.
            </p>
          </div>
        ...
        <Tabs defaultValue="preview" className="w-full space-y-8">
          ...
          <TabsContent value="preview" className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Dashboard Mockup */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <Card className="border-none shadow-sm h-full">
                  <CardContent className="p-4 space-y-4">
                    ...
                    {[
                      ...
                      <div key={item.label} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted font-medium text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer group">
              ...
              <div className="lg:col-span-9 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    { label: "Total Revenue", val: "$45,231.89", trend: "+20.1%", icon: CreditCard },
                    { label: "Subscriptions", val: "+2350", trend: "+180.1%", icon: User },
                    { label: "Active Now", val: "+573", trend: "+201", icon: BarChart3 },
                  ].map((stat) => (
                    <Card key={stat.label} className="border-none shadow-sm">
                      ...
                      <CardContent>
                        ...
                        <p className="text-[10px] text-muted-foreground mt-1">
                          <span className="text-emerald-500 font-bold mr-1">{stat.trend}</span>
                          from last month
                        </p>
                      </CardContent>
                    </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <Card className="border-none shadow-sm">
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="p-name" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Project Name</Label>
                        <Input id="p-name" defaultValue="Theme Generator Pro" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="vis" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Visibility</Label>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border/50">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-[10px] text-muted-foreground">Sync changes to the cloud.</p>
                        </div>
                    ...
                    <CardFooter className="flex justify-between bg-muted/30 pt-6">
                      ...
                      <Button size="sm" onClick={triggerToast}>Update Project</Button>
                    </CardFooter>
                  </Card>
                  ...
                  <Card className="border-none shadow-sm">
                    ...
                    <CardContent>
                      <Tabs defaultValue="all" className="w-full">
                        <TabsList className="grid w-full grid-cols-3 mb-6 bg-muted/50 p-1 h-8">
                          ...
                          <TabsTrigger value="tasks" className="text-[10px] uppercase font-bold">Tasks</TabsTrigger>
                          <TabsTrigger value="team" className="text-[10px] uppercase font-bold">Team</TabsTrigger>
                        </TabsList>
                        <TabsContent value="all" className="space-y-4">
                          {[
                            { name: "Satoshi Nakamoto", action: "pushed a new theme", time: "2h ago" },
                            { name: "Vitalik Buterin", action: "created Midnight preset", time: "5h ago" },
                            { name: "Ada Lovelace", action: "fixed radius calculation", time: "12h ago" },
                          ].map((item, i) => (
                            <div key={i} className="flex items-center gap-3 group transition-transform hover:translate-x-1">
                              ...
                              <div className="flex-1 space-y-0.5">
                                ...
                                <p className="text-[10px] text-muted-foreground">
                                  {item.action} • <span className="italic">{item.time}</span>
                                </p>
                              </div>
                            </div>
                          ))}
                    ...
                    <CardFooter className="pt-2">
                      <Button variant="outline" className="w-full border-dashed group" size="sm">
                ...
                <Card className="border-none shadow-sm overflow-hidden group">
                  ...
                  <CardContent className="text-center pb-6">
                    ...
                    <div className="flex justify-center gap-2">
                      <Button size="sm" variant="outline" className="rounded-full px-4 text-xs font-bold">Follow</Button>
                      <Button size="sm" className="rounded-full px-4 text-xs font-bold">Message</Button>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="border-none shadow-sm flex flex-col justify-center items-center p-8 text-center space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground max-w-[200px]">
                    Your search for "perfect theme" didn't return any matches. Try adjusting your filters.
                  </p>
                </div>
                <Button variant="secondary" size="sm" className="px-8 font-bold">Clear Filters</Button>
              </Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3 pt-4 border-t border-border/50">
                    <div className="flex items-center justify-between">
                      <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">System Volume</Label>
                      <span className="text-[10px] font-mono text-primary">75%</span>
                    </div>
                    <Slider defaultValue={[75]} max={100} step={1} />
                  </div>
                  <div className="flex items-center gap-2 pt-2">
                    <Button variant="destructive" size="sm" className="flex-1 font-bold">Terminate Session</Button>
                    <Button variant="outline" size="sm" disabled className="flex-1 font-bold gap-2">
          ...
          <TabsContent value="data-table" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Card className="p-8 border-border/50 bg-card/50 shadow-xl">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <h3 className="text-xl font-bold">Transaction History</h3>
                    <p className="text-sm text-muted-foreground">Manage and review your latest invoice records.</p>
                  </div>
        ...
        <div className="fixed bottom-8 right-8 animate-in slide-in-from-right-full fade-in duration-300 z-50">
          <Card className="p-4 bg-card shadow-2xl border-primary ring-1 ring-primary/20 min-w-[300px] flex items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground font-medium">Your changes have been applied in real-time.</p>
            </div>
            <Button variant="ghost" size="sm" onClick={() => setShowToast(false)} className="ml-auto opacity-50 hover:opacity-100">
              Close
            </Button>
          </Card>
        </div>
