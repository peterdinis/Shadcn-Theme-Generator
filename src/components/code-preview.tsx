...
import { Copy, Check, Download, Upload, Info } from "lucide-react";
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Export / Import</h3>
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={downloadJson} className="h-8 gap-2">
          ...
          <div className="relative">
            <input
              ...
              title="Import JSON"
            />
            <Button variant="outline" size="sm" className="h-8 gap-2 cursor-pointer pointer-events-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
              <Label className="text-xs font-bold uppercase tracking-wider text-muted-foreground">CSS Variables</Label>
            ...
            <Button
              ...
              className="h-8 gap-2"
            >
              {copied === "css" ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Theme JSON</Label>
            <Button
              variant="ghost"
              size="sm"
